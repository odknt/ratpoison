...
int group_delete_group (rp_screen *screen, rp_group *g);
...
void get_group_list (rp_screen *screen, char *delim, struct sbuf *buffer, int *mark_start,
                int *mark_end);

rp_window *group_prev_window (rp_group *g, rp_window *win);
rp_window *group_next_window (rp_group *g, rp_window *win);
rp_group *groups_find_group_by_name (rp_screen *screen, char *s, int exact_match);
rp_group *groups_find_group_by_number (rp_screen *screen, int n);
rp_group *groups_find_group_by_window (rp_window *win);
rp_group *groups_find_group_by_group (rp_screen *screen, rp_group *g);

rp_window *group_last_window (rp_group *g, rp_screen *screen);

rp_group *group_prev_group (rp_screen *screen);
rp_group *group_next_group (rp_screen *screen);
rp_group *group_last_group (rp_screen *screen);

void group_resort_group (rp_screen *screen, rp_group *g);

rp_group *group_add_new_group (rp_screen *screen, char *name);
...
void set_current_group (rp_screen *screen, rp_group *g);
